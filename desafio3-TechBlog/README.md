...
- [x] **Deploy:** Configurar e realizar o deploy da aplicação no Vercel. O link da aplicação depois de realizado o deploy [techblog-news.vercel.app](techblog-news.vercel.app).
